...
def create_inter_api_key(legal_api_name, api_file_path, user, api_key_flg=1):
    """_summary_
        ...
        match db[provider_name][action_name]: # The action exists
            case _:
                ...
                if len(inter_api_key) > 0:
                    ...
                    print(f"Created an empty API key for {legal_api_name} and saved into {api_file_path}")
